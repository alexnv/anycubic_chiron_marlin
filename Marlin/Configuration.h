...
#define MSG_MY_VERSION "V1.1.9-bugfix"
...
#define STRING_CONFIG_H_AUTHOR "(Aleksey Nepryahin, Russia)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
//#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 50, 30000 } // Changes 
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define BACK_PROBE_BED_POSITION (Y_BED_SIZE - MIN_PROBE_EDGE)
    ...
    //#define RIGHT_PROBE_BED_POSITION LEFT_PROBE_BED_POSITION+330
    #define FRONT_PROBE_BED_POSITION 30
    #define BACK_PROBE_BED_POSITION (Y_BED_SIZE - FRONT_PROBE_BED_POSITION)
    //#define BACK_PROBE_BED_POSITION FRONT_PROBE_BED_POSITION+369
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 6), (Y_MAX_POS + 1), 20 }
